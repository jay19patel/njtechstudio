        ...
        <div className="relative mb-12">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center border border-indigo-600 rounded-2xl p-6"
            >
              {/* Left Side - Image */}
              ...
              {project.liveUrl && (
                <a
                  ...
                  className="absolute top-6 right-6 p-3 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full text-indigo-600 dark:text-indigo-400 hover:bg-white dark:hover:bg-gray-800 transition-colors"
                >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                onClick={prevSlide}
                className="absolute left-4 top-1/2 -translate-y-1/2 p-2 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full text-gray-900 dark:text-white hover:bg-white dark:hover:bg-gray-800 transition-all"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                onClick={nextSlide}
                className="absolute right-4 top-1/2 -translate-y-1/2 p-2 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-full text-gray-900 dark:text-white hover:bg-white dark:hover:bg-gray-800 transition-all"
              ...
              {project.liveUrl && (
                ...
                >
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-lg font-bold text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 transition-colors"
                  >
                    {project.liveUrl}
                  </a>
                </motion.div>
