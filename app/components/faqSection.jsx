    ...
    return (
        ...
        <section className="relative pt-24 sm:pt-28 md:pt-32 pb-8 sm:pb-12 md:pb-16 lg:pb-20 overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
                ...
                <div className="absolute bottom-10 right-10 w-20 h-20 sm:w-28 sm:h-28 bg-purple-100 rounded-full opacity-15 blur-2xl"></div>
                {/* Squares */}
                ...
                <div className="absolute bottom-1/3 right-1/4 w-8 h-8 sm:w-10 sm:h-10 border-2 border-purple-200 opacity-20 rotate-12 hidden sm:block"></div>
            </div>

            <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row items-center md:items-start justify-center gap-6 sm:gap-8 lg:gap-12">
                    {/* Image on Left */}
                    ...
                    <div className="flex-1 w-full">
                        ...
                        <div className="space-y-2 sm:space-y-3">
                            {faqItems.map((item) => (
                                <div
                                    key={item.id}
                                    className={`rounded-lg border bg-white px-4 sm:px-6 py-1 transition-all duration-200 ${
                                        openItem === item.id
                                ...
                                >
                                    ...
                                    <div
                                        className={`overflow-hidden transition-all duration-200 ${
                                            openItem === item.id ? "max-h-96 pb-3 sm:pb-4" : "max-h-0"
                                        }`}
                                    >
