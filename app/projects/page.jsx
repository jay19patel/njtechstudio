      ...
      <MovingTextBg text="PROJECTS " textColor="text-gray-400">
        ...
        <section className="relative w-full pt-32 lg:pt-40 pb-12 lg:pb-20 px-4 md:px-8 lg:px-16">
          <div className="relative z-10 max-w-6xl mx-auto text-center space-y-6 lg:space-y-8">
            ...
            <div className="max-w-2xl mx-auto mt-8 lg:mt-10">
            ...
            <div className="mb-12">
              ...
              <div className="relative mb-6">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 border border-gray-300 rounded-xl bg-white text-gray-900 focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                />
              </div>
            ...
            {filteredProjects.length > 0 ? (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {filteredProjects.map((project) => (
                  <div
                    key={project.id}
                    className="group relative bg-white rounded-2xl overflow-hidden border border-gray-200 hover:border-indigo-500 transition-all duration-300 hover:shadow-2xl"
                  >
                    ...
                    {/* Project Image */}
                    <div className="relative h-72 overflow-hidden bg-indigo-100">
                      {project.image ? (
                        <Image
                          src={project.image}
                          alt={project.title}
                        ...
                        <div className="w-full h-full flex items-center justify-center">
                          <Code2 className="w-24 h-24 text-indigo-200" />
                        </div>
                      )}
                    ...
                    {/* Project Content */}
                    <div className="p-4 lg:p-6 relative z-10 pointer-events-none">
                      {/* Title */}
                      <h3 className="text-xl lg:text-2xl font-bold text-gray-900 mb-2 group-hover:text-indigo-600 transition-colors">
                        {project.title}
                      </h3>
                      ...
                      {/* Description */}
                      <p className="text-sm lg:text-base text-gray-700 mb-4 lg:mb-6 line-clamp-3">
                        {project.description}
                      </p>
                        ...
                        <div className="flex items-center gap-3">
                          {project.liveUrl && (
                            <a
                              ...
                              className="text-sm font-medium text-indigo-600 hover:text-indigo-800 transition-colors flex items-center gap-1 relative z-20"
